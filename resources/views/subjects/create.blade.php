    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Crea una nueva materia para el plan académico</p>
            </div>
        </div>
    </div>

    <div class="bg-white shadow-sm rounded-lg">
        <form action="{{ route('subjects.store') }}" method="POST" class="space-y-6 p-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="area" 
                            ...
                            <option value="Lenguaje" {{ old('area') == 'Lenguaje' ? 'selected' : '' }}>Lenguaje</option>
                            ...
                            <option value="Artes" {{ old('area') == 'Artes' ? 'selected' : '' }}>Artes</option>
                            <option value="Tecnología" {{ old('area') == 'Tecnología' ? 'selected' : '' }}>Tecnología</option>
                            <option value="Filosofía" {{ old('area') == 'Filosofía' ? 'selected' : '' }}>Filosofía</option>
                            <option value="Religión" {{ old('area') == 'Religión' ? 'selected' : '' }}>Religión</option>
                        </select>
                        @error('area')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="academic_plan_id" 
                            ...
                            @foreach($academicPlans as $plan)
                                <option value="{{ $plan->id }}" {{ old('academic_plan_id') == $plan->id ? 'selected' : '' }}>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Descripción general de la materia...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="curriculum_content" 
                                  ...
                                  placeholder="Describe el contenido curricular de la materia...">{{ old('curriculum_content') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="objectives" 
                                  ...
                                  placeholder="Define los objetivos de aprendizaje...">{{ old('objectives') }}</textarea>
                        @error('objectives')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="methodology" 
                                  ...
                                  placeholder="Describe la metodología de enseñanza...">{{ old('methodology') }}</textarea>
                        @error('methodology')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="evaluation_criteria" 
                                  ...
                                  placeholder="Define los criterios de evaluación...">{{ old('evaluation_criteria') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="prerequisites" 
                                  ...
                                  placeholder="Lista los prerrequisitos necesarios...">{{ old('prerequisites') }}</textarea>
                        @error('prerequisites')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
